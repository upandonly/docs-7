...
- [PublicNode](https://osmosis.publicnode.com) by Allnodes provides fast, free, and privacy-first RPC endpoints for Osmosis. The Osmosis RPC endpoint: `https://osmosis-rpc.publicnode.com`
